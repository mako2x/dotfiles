# Rubymotionの辞書を作る
# e.g. find /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS7.0.sdk/System/Library/Frameworks -name "*.h" | xargs ruby make_rubymotion_dict.rb
...
ruby_dict = 'ruby.dict'
unless File.exist?(ruby_dict)
  puts 'missing ruby.dict. please make ruby dict in advance.'
  exit 1
end
...
File.open('rubymotion.dict', 'w') do |f|
  f.puts File.open(ruby_dict).read
